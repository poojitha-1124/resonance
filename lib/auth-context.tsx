...
export function SignOutButton({ children, redirectUrl }: any) {
  if (isBypass) {
  ...
  if (isBypass) {
    return (
      <div 
        ...
        className="h-8 w-8 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-650 flex items-center justify-center text-white font-bold text-xs ring-2 ring-zinc-200 dark:ring-zinc-800 hover:ring-indigo-500 dark:hover:ring-violet-500 transition-all cursor-pointer"
