...
export default function DashboardError({
  ...
  React.useEffect(() => {
    // Log the error details for operational telemetry
    ...
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center animate-fade-in space-y-6">
      ...
      <div className="space-y-2 max-w-md">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
          Resonance was unable to securely sync data metrics from the Postgres servers. This can be caused by Network Timeout or invalid environment variables.
        </p>
      </div>
